          ...
          <div class="form_deg">
            <form action="{{url('update_product',$data->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="inp_deg">
                    ...
                    <textarea name="description"  cols="30" required> {{$data->description}} </textarea>
                </div>
                <div class="inp_deg">
                ...
                <div class="inp_deg">
                    ...
                    <img height="150px" src="/products/{{$data->image}}"  alt="image not available">
                </div>
                <div class="inp_deg">
                ...
                <div class="inp_deg">
                    <div class="subButton">
                        <input class="btn btn-success" id="sub" type="submit" value="Update Product">
                    </div>
